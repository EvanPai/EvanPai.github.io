...
**Muay Thai.** I train regularly, and the appeal is how unsentimental the feedback
is. You do not find out that your guard drops when you are tired by being told — you
find out because somebody exploits it, immediately, and then you go fix it. It has
more in common with profiling code than I expected: the weakness is never quite
where you assumed, and you cannot fix what you have not measured.

![Pad work. The part nobody watches, and the part that decides everything else.](images/life/muaythai.jpg){fig-alt="Evan Pai training Muay Thai, hitting pads"}

**Cosplay.** I build costumes and take them to conventions — two characters
finished so far, and a longer list I have not earned the free weekends for yet.
People are sometimes surprised that this is the hobby of a systems engineer, but it
is the most familiar thing I do: study something complicated closely enough to
rebuild it, work out how to fabricate each piece with the tools and budget you
actually have, and ship it by a deadline that does not move, because the convention
starts on Saturday whether the armour is finished or not.

::: {layout-ncol=2}
![One of two characters I have built and worn so far.](images/life/cosplay-1.jpg){fig-alt="Evan Pai in costume at a convention"}

![Different character, same problem: study it, build it, wear it in public.](images/life/cosplay-2.jpg){fig-alt="Evan Pai in a second cosplay costume at a convention"}
:::

Both of these are the same instinct that got me into high-performance computing,
honestly. Take something complicated apart, build it back better than you found it,
and then go and find out in public whether it actually holds up.
