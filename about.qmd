...
**Muay Thai.** I train a few times a week. It is the one hour where nobody expects
me to have an opinion about GPUs, and the feedback is refreshingly direct — you find
out which of your habits are bad ones almost immediately. It keeps me fit and builds
a useful kind of resilience, and I would be lying if I said that was the whole
appeal. Hitting things is fun.

![Pad rounds. Good for the cardio, humbling for everything else.](images/life/muaythai.jpg){fig-alt="Evan Pai training Muay Thai, hitting pads"}
...
is hard to explain until you have tried it, and watching the list of characters
