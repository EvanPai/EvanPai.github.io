...
**Muay Thai.** I train regularly. Mostly it keeps me in shape and gives my week
something that has nothing to do with a screen, and rounds on the pads are good for
building resilience — the physical kind, and the kind where you keep going after you
are already tired.

![Pad work at the gym.](images/life/muaythai.jpg){fig-alt="Evan Pai training Muay Thai, hitting pads"}

**Cosplay.** I go to conventions in costume. Nothing hardcore — the outfits and wigs
are bought rather than built. I put everything on in the morning, do the character
makeup, and bring a camera along for the day. Two characters so far. It is a few
hours completely outside ordinary life, and getting the details right takes more
patience than people tend to expect.

::: {layout-ncol=2}
![One of the two characters I have worn so far.](images/life/cosplay-1.jpg){fig-alt="Evan Pai in costume at a convention"}

![Conventions are worth going to for the atmosphere alone.](images/life/cosplay-2.jpg){fig-alt="Evan Pai in a second cosplay costume at a convention"}
:::
